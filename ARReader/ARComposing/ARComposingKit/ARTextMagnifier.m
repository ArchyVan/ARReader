...
@interface _ARTextMagnifierCaret : ARTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _ARTextMagnifierCaret
...
- (ARTextMagnifierType)type {
    return ARTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(ARTextCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, ARTextCGFloatFromPixel(1));
...
@interface _ARTextMagnifierRanged : ARTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _ARTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding ARTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (ARTextMagnifierType)type {
    return ARTextMagnifierTypeRanged;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, ARTextCGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, ARTextCGFloatPixelFloor(kPadding) + kHeight);
...
@implementation ARTextMagnifier

+ (id)magnifierWithType:(ARTextMagnifierType)type {
    switch (type) {
        case ARTextMagnifierTypeCaret :return [_ARTextMagnifierCaret new];
        case ARTextMagnifierTypeRanged :return [_ARTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[ARTextMagnifier class]]) {
